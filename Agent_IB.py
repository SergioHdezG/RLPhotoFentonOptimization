...
from src.environments import perox_complete_model_small_increments_sec_init
...
if data['optimize_peroxide']:
    m_cinetico = perox_complete_model_small_increments_sec_init.env(sodis=False, perox=True, bact=False,
                                                                 log_alpha_values_init=log_alpha_values_init,
                                                                 log_scale=False)

if data['optimize_bacteria']:
    m_cinetico = perox_complete_model_small_increments_sec_init.env(sodis=False, perox=False, bact=True,
                                                                 log_alpha_values_init=log_alpha_values_init,
                                                                log_scale=False)
