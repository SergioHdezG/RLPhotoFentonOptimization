...
from RL_Agent import ppo_agent_continuous_parallel_hindsight
from utils.preprocess import *
from utils import hyperparameters as hyperparams
from RL_Problem import rl_problem
from src.environments import perox_complete_model_small_glob_coord_hindsight
...
if data['optimize_peroxide']:
    m_cinetico = perox_complete_model_small_glob_coord_hindsight.env(sodis=False, perox=True, bact=False,
                                                                 log_alpha_values_init=log_alpha_values_init,
                                                                 log_scale=False)

if data['optimize_bacteria']:
    m_cinetico = perox_complete_model_small_glob_coord_hindsight.env(sodis=False, perox=False, bact=True,
                                                                 log_alpha_values_init=log_alpha_values_init,
                                                                log_scale=False)
...
agent= ppo_agent_continuous_parallel_hindsight.Agent(actor_lr=float(data['actor_lr']),
...
if data['optimize_peroxide']:
    problem.preprocess = perox_only_norm_hind_linear
if data['optimize_bacteria']:
    problem.preprocess = bact_only_norm_hind_linear
