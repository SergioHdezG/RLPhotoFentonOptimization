...
from RL_Agent.ActorCritic.A3C_Agent import a3c_globals as glob
from RL_Agent.ActorCritic.A3C_Agent.Networks.a3c_net_continuous import *
...
class Worker(object):
    def __init__(self, name, globalAC, sess, state_size, n_actions, environment, n_stack=1, img_input=False,
        ...
        self.sess = sess
        self.AC = ACNet(name, self.sess, state_size, self.n_actions, stack=stack, img_input=self.img_input, lr_actor=lr_actor, lr_critic=lr_critic,
